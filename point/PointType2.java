...
public class PointType2 extends PointAbstrait {
	...
	public boolean bouger() {
		...
		deciderAvancerOuReculer();

		if (avancerPlutotReculer) {
	...
	private void deciderAvancerOuReculer() {
